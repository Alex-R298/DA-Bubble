...
/**
 * Helper class for handling search functionality in the header component
...
export class HeaderSearchHelper {
  ...
  onSearchInput(value: string): void {
    ...
    // Immediately hide results if query is cleared
    if (!value.trim()) {
      this.debouncedQuery = '';
      this.showSearchResults = false;
      this.clearCachedResults();
    } else {
      // Emit to debounced subject for processing
  ...
  /** Returns cached filtered channels */
  get filteredChannelsCache(): Channel[] {
    return this.cachedChannels;
  }

  /** Returns cached filtered users */
  get filteredUsersCache(): User[] {
    return this.cachedUsers;
  }

  /** Returns cached filtered messages */
  get filteredMessagesCache(): SearchMessageResult[] {
    return this.cachedMessages;
  }

  /** Returns cached mention users */
  get filteredMentionUsersCache(): User[] {
    return this.cachedMentionUsers;
  }

  /** Returns cached mention channels */
  get filteredMentionChannelsCache(): Channel[] {
